<?php
/**
 * Franchise Distributor Partner (Premium Plan) Email Template
 * Template for PREMIUM joining deal emails
 */
...
function getPremiumJoiningDealEmail($user_name, $user_email) {
    ...
    $message .= "1. Pay one-time fee to join us with a Premium Plan (Non-Refundable)\n";
    $message .= "👉 Amount: ₹7,500 + 18% GST = ₹8,850/-\n";
