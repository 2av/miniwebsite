...
<!-------------------form ----------------------->	
		...
		<div class="input_box"><p>Account Type (Optional) </p><select type="text" name="d_ac_type" maxlength="100"   ><option value="<?php if(!empty($row['d_ac_type'])){echo $row['d_ac_type'];}?>">-Select-</option><option>Savings Account</option><option>Current Account</option></select></div>
		
		<h3>Payment QR Code</h3>
		<div class="divider"><div class="num">Paytm QR Code</div>
		
		<img src="<?php if(!empty($row['d_qr_paytm'])){echo 'data:image/*;base64,'.base64_encode($row['d_qr_paytm']);}else {echo '../panel/images/upload-qr.jpg';} ?>" alt="Select image" id="showPreviewLogo10" onclick="clickFocus10()" >
		<div class="input_box">
		...
		<img src="<?php if(!empty($row['d_qr_google_pay'])){echo 'data:image/*;base64,'.base64_encode($row['d_qr_google_pay']);}else {echo '../panel/images/upload-qr.jpg';} ?>" alt="Select image" id="showPreviewLogo3" onclick="clickFocus3()" >
		<div class="input_box">
		...
		<img src="<?php if(!empty($row['d_qr_phone_pay'])){echo 'data:image/*;base64,'.base64_encode($row['d_qr_phone_pay']);}else {echo '../panel/images/upload-qr.jpg';} ?>" alt="Select image" id="showPreviewLogo2" onclick="clickFocus2()" >
		<div class="input_box">
