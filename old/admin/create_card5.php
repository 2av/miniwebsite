...
for ($m=1;$m <= 10; $m++){
	...
	;}?>
		...
		<img src="<?php if(!empty($row2["d_pro_img$m"])){echo 'data:image/*;base64,'.base64_encode($row2["d_pro_img$m"]);}else {echo '../panel/images/upload.png';} ?>" alt="Select image" id="<?php  echo "showPreviewLogo$m"; ?>" onclick="<?php  echo "clickFocus($m)"; ?>" >
		<div class="input_box">
