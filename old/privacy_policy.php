...
try {
    ...
    $query = mysqli_query($connect, "SELECT * FROM content_management WHERE content_type='privacy_policy' AND is_active=1");
    ...
    if(mysqli_num_rows($query) > 0) {
        ...
        $meta_description = "Privacy Policy for MiniWebsite";
