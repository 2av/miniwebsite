            ...
            <div class="card-body">
                ...
                <form action="" method="POST" enctype="multipart/form-data" id="card_form">
                    <div class="form-group">
                        <label for="d_fb">Facebook  <img src="../../customer/assets/img/facebook.png" width="30" alt=""></label>
                    ...
                    <div class="form-group">
                        <label for="d_instagram">Instagram  <img src="../../customer/assets/img/instagram.png" width="30" alt=""></label>
                    ...
                    <div class="form-group">
                        <label for="d_youtube">YouTube <img src="../../customer/assets/img/youtube.png" width="30" alt=""></label>
                    ...
                    <div class="form-group">
                        <label for="d_twitter">X (Twitter)  <img src="../../customer/assets/img/twitter.png" width="30" alt=""></label>
                    ...
                    <div class="form-group">
                        <label for="d_linkedin">LinkedIn  <img src="../../customer/assets/img/linkedin.png" width="30" alt=""></label>
                    ...
                    <div class="form-group">
                        <label for="d_pinterest">Pinterest  <img src="../../customer/assets/img/pinterest.png" width="30" alt=""></label>
                    ...
                    <div class="Product-ServicesBtn" style="margin-top: 20px;">
                        ...
                        <button type="submit" name="process3" class="btn btn-primary align-center">
