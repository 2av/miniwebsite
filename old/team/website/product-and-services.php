...
// Get user_id - ALWAYS check user_details FIRST (unified table for all users)
// Must be done before form processing
...
<main class="Dashboard">
    <div class="container-fluid customer_content_area">
        <div class="main-top">
        <span class="headingTop">Product & Service</span>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <label class="heading">Product &amp; Services:</label>
                <p>You can add upto 10 products &amp; services which you want to showcase on your Mini Website.</p>
                ...
                <div class="Product-ServicesTable">
                    ...
                    <div class="Product-ServicesBtn">
                        ...
                        <button type="button" class="btn btn-primary align-center" onclick="saveProducts()">
...
@media screen and (max-width: 768px) {
    ...
    .container-fluid, .customer_content_area, .card, .card-body {
        overflow-x: hidden !important;
        max-width: 100% !important;
    }
    ...
    /* Make only the table scrollable, not the whole page */
    .Product-ServicesTable{
        width: 100% !important;
        max-width: 100% !important;
