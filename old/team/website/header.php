...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <div class="head-left">
            <a class="navbar-brand ps-3" href="../../team/dashboard/">
                ...
                <li class="nav-item upload-profile-wrap">
                    <a class="nav-link">
                        <div class="upload-profile">
                            <div class="circle">
                                <img class="profile-pic" src="../../team/<?php echo $user_image; ?>" alt="" srcset=""> 
                                <span>
                                    <?php 
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="../../team/dashboard/">Dashboard</a></li>
                        <li><a class="dropdown-item" href="../../team/referral-details/">Referral Details</a></li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item" href="../../team/logout.php">Logout</a></li>
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <nav class="sb-sidenav accordion" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        ?>
                        <a class="nav-link collapsed <?php echo ($current_dir == 'dashboard') ? 'active' : ''; ?>" href="../../team/dashboard/">
                        ...
                        <a class="nav-link collapsed <?php echo ($current_page == 'business-name.php') ? 'active' : ''; ?>" href="business-name.php<?php echo $card_query; ?>">
                                    <div class="sb-nav-link-icon"><img src="../../customer/assets/img/BusinessName.png" class="img-fluid" alt="" srcset=""></div>
                                    Business Name
                                    <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                                </a> 
                                <a class="nav-link collapsed <?php echo ($current_page == 'select-theme.php') ? 'active' : ''; ?>" href="select-theme.php<?php echo $card_query; ?>">
                                    <div class="sb-nav-link-icon"><img src="../../customer/assets/img/SelectTheme.png" class="img-fluid" alt="" srcset=""></div>
                                    Select Theme
                                    <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                                </a>
                                <a class="nav-link collapsed <?php echo ($current_page == 'company-details.php') ? 'active' : ''; ?>" href="company-details.php<?php echo $card_query; ?>">
                                    <div class="sb-nav-link-icon"><img src="../../customer/assets/img/CompanyDetails.png" class="img-fluid" alt="" srcset=""></div>
                                    Company Details
                                    <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                                </a>
                                <a class="nav-link collapsed <?php echo ($current_page == 'social-links.php') ? 'active' : ''; ?>" href="social-links.php<?php echo $card_query; ?>">
                                    <div class="sb-nav-link-icon"><img src="../../customer/assets/img/SocialLinks.png" class="img-fluid" alt="" srcset=""></div>
                                    Social Links
                                    <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                                </a>
                                <a class="nav-link collapsed <?php echo ($current_page == 'payment-details.php') ? 'active' : ''; ?>" href="payment-details.php<?php echo $card_query; ?>">
                                    <div class="sb-nav-link-icon"><img src="../../customer/assets/img/PaymentDetails.png" class="img-fluid" alt="" srcset=""></div>
                                    Payment Details
                                    <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                                </a>
                                <a class="nav-link collapsed <?php echo ($current_page == 'product-and-services.php') ? 'active' : ''; ?>" href="product-and-services.php<?php echo $card_query; ?>">
                                    <div class="sb-nav-link-icon"><img src="../../customer/assets/img/ProductServices.png" class="img-fluid" alt="" srcset=""></div>
                                    Product &amp; Services
                                    <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                                </a>
                                <a class="nav-link collapsed <?php echo ($current_page == 'product-pricing.php') ? 'active' : ''; ?>" href="product-pricing.php<?php echo $card_query; ?>">
                                    <div class="sb-nav-link-icon"><img src="../../customer/assets/img/ProductPricing.png" class="img-fluid" alt="" srcset=""></div>
                                    Product Pricing
                                    <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                                </a>
                                <a class="nav-link collapsed <?php echo ($current_page == 'image-gallery.php') ? 'active' : ''; ?>" href="image-gallery.php<?php echo $card_query; ?>">
                                    <div class="sb-nav-link-icon"><img src="../../customer/assets/img/ImageGallery.png" class="img-fluid" alt="" srcset=""></div>
                                    Image Gallery
                                    <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                                </a>
                                <a target="_blank" class="nav-link collapsed <?php echo ($current_page == 'n.php' && !empty($business_name_slug)) ? 'active' : ''; ?>" href="../../n.php?n=<?php echo htmlspecialchars($business_name_slug); ?>">
                                    <div class="sb-nav-link-icon"><img src="../../Common/assets/img/Preview.png" class="img-fluid" alt="" srcset=""></div>
                                    Preview
                                    <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                                </a>
                    </div>
