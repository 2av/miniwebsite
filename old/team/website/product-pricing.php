...
<main class="Dashboard">
    <div class="container-fluid customer_content_area">
        <div class="main-top">
        <span class="headingTop">Product Pricing</span>
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <p>You can add upto 60 products with pricing which you want to showcase on your Mini Website.</p>
                ...
                <div class="Product-ServicesTable">
                    ...
                    <div class="Product-ServicesBtn">
                        ...
                        <button class="btn btn-primary align-center" onclick="saveProducts()"><img src="../../customer/assets/img/Save.png" class="img-fluid" width="35px" alt=""> <span>Save</span></button>
