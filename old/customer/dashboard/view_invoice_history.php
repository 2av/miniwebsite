                 ...
                 <table class="table table-striped table-hover border">
                    ...
                    <tbody>
                         ...
                         <tr class="align-middle">
                             ...
                             <td>
                             <span class="download"><a target="_blank" href="../dashboard/download_invoice_new.php?id=<?php echo $invoice['id']; ?>" title="Download Invoice"><img src="../assets/img/download.png" alt=""></a></span>
                             </td>
                         </tr>
                        <?php } ?>
                    </tbody>
