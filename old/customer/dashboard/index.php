                    ...
                    <div class="row">
                        <div class="col-sm-3 top_section">
                            <a href="../website/business-name.php?new=1">
                                <div class="card">
                                    <div class="img">
                                        <img class="img-fluid" src="../assets/img/Edit-icon.png" alt="">
                                    </div>
                                    <div class="content">
                                ...
                                <td style="display:flex; align-items: center; gap: 5px;">
                                   ...
                                   // }
                                    ...
                                    <span class="view"> <a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/n.php?n=<?php echo $row['card_id']; ?>" target="_blank" style="text-decoration: none; color: inherit;">
                                     <!-- <img src="../assets/img/eye.png" class="img-fluid" width="30px" alt="">      -->
                                     <span class="view_icon_style"><i class="fa-regular fa-eye"></i></span>
                                   
                                    </a></span>
                                    <span class="edit">
                                        <a href="<?php echo $edit_link; ?>">
                                        <!-- <img src="../assets/img/edit.png" width="30px" alt=""> -->
                                    ...
                                    <span class="share"><a href="https://api.whatsapp.com/send?text=<?php echo urlencode('https://'.$_SERVER['HTTP_HOST'].'/'.$row['card_id']); ?>" target="_blank">
                                        <!-- <img src="../assets/img/share.png" width="30px" alt=""> -->
                ...
                <?php if($collaboration_enabled!='Yes' || (isset($mw_referral_id) && $mw_referral_id == 1)): ?>
                        <div class="referral-id">Mini websites Referral ID</div>                
                                ...
                                <div class="social-icons">
                                    ...
                                    <ul>
                                        <li><a href="https://api.whatsapp.com/send?text=<?php echo urlencode('Join using my referral link: https://miniwebsite.in/panel/login/create-account.php?ref='.$user_referral_code); ?>" target="_blank"><img src="../assets/img/whatsapp.png" alt=""></a></li>
                                        <li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('https://miniwebsite.in/panel/login/create-account.php?ref='.$user_referral_code); ?>" target="_blank"><img src="../assets/img/facebook.png" alt=""></a></li>
                                        <li><a href="https://www.instagram.com/share?url=<?php echo urlencode('https://miniwebsite.in/panel/login/create-account.php?ref='.$user_referral_code); ?>" target="_blank"><img src="../assets/img/instagram.png" alt=""></a></li>
                                        <li><a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Join using my referral link: https://miniwebsite.in/panel/login/create-account.php?ref='.$user_referral_code); ?>&url=<?php echo urlencode('https://miniwebsite.in/panel/login/create-account.php?ref='.$user_referral_code); ?>" target="_blank"><img src="../assets/img/twitter.png" alt=""></a></li>
                                        <li><a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo urlencode('https://miniwebsite.in/panel/login/create-account.php?ref='.$user_referral_code); ?>" target="_blank"><img src="../assets/img/linkedin.png" alt=""></a></li>
                                    </ul>
                                </div>
                    <?php endif; ?>
...
<?php endif; ?>
                            ...
                            <div class="referral-id">Franchise Referral ID</div>
                                ...
                                <div class="social-icons">
                                    <p>Refer Franchise</p>
                                    <ul>
                                        <li><a href="https://api.whatsapp.com/send?text=<?php echo urlencode('Join using my collaboration link: https://miniwebsite.in/panel/login/create-franchisee-account.php?ref='.$user_referral_code); ?>" target="_blank"><img src="../assets/img/whatsapp.png" alt=""></a></li>
                                        <li><a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode('https://miniwebsite.in/panel/login/create-franchisee-account.php?ref='.$user_referral_code); ?>" target="_blank"><img src="../assets/img/facebook.png" alt=""></a></li>
                                        <li><a href="https://www.instagram.com/share?url=<?php echo urlencode('https://miniwebsite.in/panel/login/create-franchisee-account.php?ref='.$user_referral_code); ?>" target="_blank"><img src="../assets/img/instagram.png" alt=""></a></li>
                                        <li><a href="https://twitter.com/intent/tweet?text=<?php echo urlencode('Join using my collaboration link: https://miniwebsite.in/panel/login/create-franchisee-account.php?ref='.$user_referral_code); ?>&url=<?php echo urlencode('https://miniwebsite.in/panel/login/create-franchisee-account.php?ref='.$user_referral_code); ?>" target="_blank"><img src="../assets/img/twitter.png" alt=""></a></li>
                                        <li><a href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo urlencode('https://miniwebsite.in/panel/login/create-franchisee-account.php?ref='.$user_referral_code); ?>" target="_blank"><img src="../assets/img/linkedin.png" alt=""></a></li>
                                    </ul>
                                </div>
                        </div>
                        <?php endif; ?>
