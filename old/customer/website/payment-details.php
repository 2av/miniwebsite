                        ...
                        <div class="card">
                            <div class="logo-placeholder" id="gpayPreview" onclick="clickFocus3()">
                                <?php if(!empty($row['d_qr_google_pay'])): ?>
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    <img id="showPreviewLogo3" src="../assets/img/Gpay.png" class="img-fluid" style="display:none;">
                        ...
                        <div class="card">
                            <div class="logo-placeholder" id="paytmPreview" onclick="clickFocus10()">
                                <?php if(!empty($row['d_qr_paytm'])): ?>
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    <img id="showPreviewLogo10" src="../assets/img/paytm.png" class="img-fluid" style="display:none;">
                                    <small>ADD QR CODE</small>
                                <?php endif; ?>
                            </div>
                            <div class="file-info">File Supported - .png, .jpg, .jpeg, .gif, .webp</div>
                        ...
                        <div class="card">
                            <div class="logo-placeholder" id="phonepePreview" onclick="clickFocus2()">
                                <?php if(!empty($row['d_qr_phone_pay'])): ?>
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    <img id="showPreviewLogo2" src="../assets/img/phonepe.png" class="img-fluid" style="display:none;">
                                    <small>ADD QR CODE</small>
                                <?php endif; ?>
                            </div>
                            <div class="file-info">File Supported - .png, .jpg, .jpeg, .gif, .webp</div>
