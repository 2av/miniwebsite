        ...
        <div class="card mb-4">
                ...
                <button class="btn btn-primary add_image" onclick="openImageModal()" style="width: auto;"><i class="fa fa-plus" aria-hidden="true"></i> <span>Add Images</span></button>
                            ...
                            ?>
                                <tr data-image-id="<?php echo $img_id; ?>" data-card-id="<?php echo $row['id']; ?>">
                                        ...
                                        <a class="edit" href="javascript:void(0);" onclick="editImage(<?php echo $img_id; ?>)">
                                            <img src="../assets/img/edit1.png" alt="">
                                        </a>
                    ...
                    <form id="imageForm" action="" method="POST" enctype="multipart/form-data" style="display:none;">
                        ...
                        <button class="btn btn-primary align-center save_btn" onclick="saveImages()"><img src="../assets/img/Save.png" class="img-fluid" width="35px" alt=""> <span>Save</span></button>
