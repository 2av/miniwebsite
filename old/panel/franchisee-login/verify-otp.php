...
if(isset($_POST['verify_otp'])){
    ...
    $query = mysqli_query($connect, "SELECT * FROM franchisee_login WHERE f_user_email='$email' AND reset_otp='$otp'");
...
if(isset($_POST['resend_otp']) && isset($_SESSION['otp_email'])) {
    ...
    $query = mysqli_query($connect, "SELECT * FROM franchisee_login WHERE f_user_email='$email'");
    ...
    if(mysqli_num_rows($query) > 0) {
        ...
        $update = mysqli_query($connect, "UPDATE franchisee_login SET reset_otp='$otp', reset_otp_expiry='$expiry' WHERE f_user_email='$email'");
        ...
        <div class="login-container">
            ...
            <form action="" method="post" class="mt-3">
                <div class="Reset-foot">
                    <p class="text-white">Didn't receive OTP? <input type="submit" name="resend_otp" value="Resend OTP" class="resend-code"></p>
                </div>
            </form>
        </div>
    </div>
