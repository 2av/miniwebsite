...
if(isset($row) && $row && $row['d_card_status']=="Active" && $row['d_payment_status']=="Success"){
    ...
    <div class="container">
        ...
        <a href="https://'.$_SERVER['HTTP_HOST'].'/panel/login/payment_page/pay.php?id='.$row['id'].'" class="button-box">Pay Now</a>
        <div class="help-box">
            Need Help?<br>
	...
	<div class="card2" id="shop_online">
		...
		for($x=0;$x<=20;$x++){
			if(!empty($row3["pro_name$x"])){
				...
				echo "<a href='https://api.whatsapp.com/send?phone=91".str_replace("+91","",$row['d_whatsapp'])."&text=Hello sir, I checked your products on your digital visiting card. I am interested in Product: ".$row3["pro_name$x"].", Price: ".$row3["pro_mrp$x"]."' target='_blank'><div class='btn_buy'>Inquire Now</div></a>";
