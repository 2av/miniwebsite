...
// Get all active kit items
$kit_items_query = "SELECT * FROM franchisee_kit WHERE status = 'active' ORDER BY display_order ASC, created_at DESC";
...
<main class="Dashboard">
    <div class="container-fluid customer_content_area">
        <div class="main-top">
        <span class="heading">Franchise Kit</span>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="../dashboard/">Mini Website </a></li>
                  <li class="breadcrumb-item active" aria-current="page">Franchisee Kit</li>
                </ol>
            </nav>                              
        </div>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <div class="FranchiseeDashboard-head">
                    <span class="heading">Franchisee Kit</span>
                    ...
                    <div class="row mb-5">
                        <div class="col-12">
                            <h4 class="mb-3 heading2">Promotional Images</h4>
                            <div class="row">
                                <?php foreach ($images as $image): ?>
                                <div class="col-md-3 col-sm-6 mb-4">
                                    <div class="">
                                    <div class=" h-100">
                                        <img src="uploads/<?php echo htmlspecialchars($image['file_path']); ?>" 
                                            ...
                                            <div class="mt-auto d-flex" style="padding: 10px;    justify-content: space-between;">
                                                ...
                                                <a href="uploads/<?php echo htmlspecialchars($image['file_path']); ?>" 
...
<div class="row">
    <div class="col-12">
        ...
        <!-- ================= YOUTUBE VIDEOS ================= -->
        <h4 class="heading">YouTube Videos</h4>
        <div class="row">
            ...
            <?php if ($youtubeId): ?>
            <div class="col-lg-3 col-md-4 col-sm-6 mb-4 small_device_center">
                <div class="card h-100">
                    <div class="card-body p-2 video_section">
                        <!-- <h6 class="text-center">
                            <?= htmlspecialchars($video['title'] ?: 'Video'); ?>
                        </h6> -->
        ...
        <div class="row">
            ...
            <?php foreach ($videos as $index => $video): ?>
            <?php if (strpos($video['video_url'], 'instagram.com') !== false): ?>
                ...
                <div class="card h-100">
                    <div class="card-body p-2 video_section">
                        ...
                        <blockquote class="instagram-media"
                            data-instgrm-permalink="<?= htmlspecialchars($video['video_url']); ?>"
