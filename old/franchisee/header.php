...
if(!isset($_SESSION['f_user_email']) || !isset($_SESSION['f_is_logged_in']) || $_SESSION['f_is_logged_in'] !== true) {
    ...
    header('Location: ../../panel/franchisee-login/login.php?session=expired');
    exit;
}
...
$page_title = "Franchisee Portal";

// Get user profile image from database
$user_image = '';
if(isset($_SESSION['f_user_email'])) {
    try {
        $stmt = $connect->prepare("SELECT profile_image FROM franchisee_users WHERE email = ?");
        ...
        // If there's an error, $user_image will remain empty and default image will be used
        error_log("Error fetching user profile image: " . $e->getMessage());
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="../../common/assets/css/responsive.css">
    <link rel="stylesheet" href="../../common/assets/css/dashboard-professional.css">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <div class="head-left">
            <a class="navbar-brand ps-3" href="index.php">
                <img src="../../common/assets/img/logo.png" class="img-fluid" alt="" srcset="">
            </a>
        ...
        <div class="head-right">
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                                 <li class="nav-item dropdown upload-profile-wrap">
                     <div class="upload-profile">
                         <div class="circle">
                             <img class="profile-pic" src="<?php echo (file_exists('../' . $user_image) && !empty($user_image)) ? '../' . $user_image : '../../common/assets/img/profile-default.png'; ?>" alt="" srcset=""> 
                             <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-expanded="false" style="display: inline; padding: 0;">
                                 <span>
                                     <?php 
                                     echo isset($_SESSION['f_user_name']) ? htmlspecialchars($_SESSION['f_user_name']) : 'Guest'; 
                                     ?> 
                                     <i class="fa fa-angle-double-down"></i>
                                 </span>
                             </a>
                         </div>
                         <div class="p-image" title="Click to upload profile image (Max: 250KB, Formats: JPG, PNG, GIF)" style="pointer-events: auto; position: relative; z-index: 10;">
                            <img src="../../common/assets/img/camera.png" class="upload-button img-fluid" alt="" style="cursor: pointer;">
                          ...
                          <li><a class="dropdown-item" href="../dashboard/">Dashboard</a></li>
                           <li><a class="dropdown-item" href="../../panel/franchisee-login/logout.php"> Logout</a></li>
                      </ul>
                 </li>
            </ul>
        </div>
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link collapsed <?php echo ($current_dir == 'dashboard') ? 'active' : ''; ?>" href="../dashboard/">
                            <div class="sb-nav-link-icon"><img  src="../../common/assets/img/Dashboard.png" class="img-fluid" alt="" srcset=""></div>
                            Dashboard
                            <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                        </a>
                        <a class="nav-link collapsed <?php echo ($current_dir == 'verification') ? 'active' : ''; ?>" href="../verification/">
                            <div class="sb-nav-link-icon"><img src="../../common/assets/img/Verification.png" class="img-fluid" alt="" srcset=""></div>
                            Verification
                            <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                        </a>
                        <?php if($is_verified): ?>
                            <a class="nav-link collapsed <?php echo ($current_dir == 'wallet') ? 'active' : ''; ?>" href="../wallet/">
                            ...
                            <a class="nav-link collapsed <?php echo ($current_dir == 'kit') ? 'active' : ''; ?>" href="../kit/">
                                <div class="sb-nav-link-icon"><img src="../../common/assets/img/FranchiseeKit.png" class="img-fluid" alt="" srcset=""></div>
                                Franchisee Kit
                                <div class="sb-sidenav-collapse-arrow"><i class="fa fa-angle-down"></i></div>
                            </a>
                        <?php else: ?>
                        ...
                        <div class="nav-link" style="margin-top: 20px;">
                            <a href="../download_invoice.php" class="btn btn-warning btn-sm" 
...
<div class="modal fade" id="profileImageCropModal" tabindex="-1" role="dialog" aria-labelledby="profileImageCropModalLabel" aria-hidden="true">
    ...
    <!-- Bootstrap JavaScript - jQuery and Bootstrap will be loaded in footer -->
     ...
     .scrollable-dropdown .dropdown-divider {
         margin: 5px 0;
     }
